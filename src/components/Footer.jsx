...
import { Heart, Envelope, Smartphone, MapPin } from '@gravity-ui/icons';
...
const footerLinks = {
  ...
  adopt: [
    ...
    { label: 'Dogs', href: '/pets?type=dog' },
    { label: 'Cats', href: '/pets?type=cat' },
    { label: 'Other Pets', href: '/pets?type=other' },
  ],
  support: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 max-w-xs">
              Connecting loving families with pets in need of a home. Every pet deserves a loving family, and every family deserves a loyal companion.
            </p>
            {/* Contact Info */}
            <div className="space-y-3">
              <a href="mailto:hello@petghor.com" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
          ...
          >
            <h3 className="text-foreground font-semibold mb-4">Adopt</h3>
            <ul className="space-y-3">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            <div className="text-center md:text-left">
              ...
              <p className="text-sm text-muted-foreground">Get updates on new pets and adoption events</p>
            </div>
            <form className="flex gap-2 w-full md:w-auto">
              <input 
                type="email" 
                placeholder="Enter your email"
                className="flex-1 md:w-64 px-4 py-2.5 rounded-lg border border-border bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
              />
              <button 
                type="submit"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} PetGhor. All rights reserved.
            </p>
